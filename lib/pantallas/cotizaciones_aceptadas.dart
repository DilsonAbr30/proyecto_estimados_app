...
import 'detalles_cotizacion_aceptada.dart'; // <-- Nueva pantalla de detalles

class CotizacionesAceptadasScreen extends StatefulWidget {
  const CotizacionesAceptadasScreen({super.key});

  @override
  State<CotizacionesAceptadasScreen> createState() =>
      _CotizacionesAceptadasScreenState();
}

class _CotizacionesAceptadasScreenState
    extends State<CotizacionesAceptadasScreen> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        stream: _firestore
            ...
            .where('estado_estimado', isEqualTo: 'aceptada') // <-- Filtro cambiado
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DetallesCotizacionAceptadaScreen( // <-- Nueva pantalla
                          cotizacionId: doc.id,
                          cotizacionData: data,
                        ),
                      ),
